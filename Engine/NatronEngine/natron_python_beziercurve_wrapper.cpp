...
static const char *Natron_Python_BezierCurve_SignatureStrings[] = {
    "NatronEngine.Natron.Python.BezierCurve.addControlPoint(x:double,y:double)",
    "NatronEngine.Natron.Python.BezierCurve.addControlPointOnSegment(index:int,t:double)",
    "NatronEngine.Natron.Python.BezierCurve.getActivatedParam()->NatronEngine.Natron.Python.BooleanParam",
    "NatronEngine.Natron.Python.BezierCurve.getColor(time:double)->NatronEngine.Natron.Python.ColorTuple",
    "NatronEngine.Natron.Python.BezierCurve.getColorParam()->NatronEngine.Natron.Python.ColorParam",
    "NatronEngine.Natron.Python.BezierCurve.getCompositingOperator()->NatronEngine.Natron.MergingFunctionEnum",
    "NatronEngine.Natron.Python.BezierCurve.getCompositingOperatorParam()->NatronEngine.Natron.Python.ChoiceParam",
    "NatronEngine.Natron.Python.BezierCurve.getControlPointPosition(index:int,time:double,x:double*,y:double*,lx:double*,ly:double*,rx:double*,ry:double*)",
    "NatronEngine.Natron.Python.BezierCurve.getFeatherDistance(time:double)->double",
    "NatronEngine.Natron.Python.BezierCurve.getFeatherDistanceParam()->NatronEngine.Natron.Python.DoubleParam",
    "NatronEngine.Natron.Python.BezierCurve.getFeatherFallOff(time:double)->double",
    "NatronEngine.Natron.Python.BezierCurve.getFeatherFallOffParam()->NatronEngine.Natron.Python.DoubleParam",
    "NatronEngine.Natron.Python.BezierCurve.getFeatherPointPosition(index:int,time:double,x:double*,y:double*,lx:double*,ly:double*,rx:double*,ry:double*)",
    "NatronEngine.Natron.Python.BezierCurve.getIsActivated(time:double)->bool",
    "NatronEngine.Natron.Python.BezierCurve.getKeyframes(keys:std.list[double])",
    "NatronEngine.Natron.Python.BezierCurve.getNumControlPoints()->int",
    "NatronEngine.Natron.Python.BezierCurve.getOpacity(time:double)->double",
    "NatronEngine.Natron.Python.BezierCurve.getOpacityParam()->NatronEngine.Natron.Python.DoubleParam",
    "NatronEngine.Natron.Python.BezierCurve.getOverlayColor()->NatronEngine.Natron.Python.ColorTuple",
    "NatronEngine.Natron.Python.BezierCurve.isCurveFinished()->bool",
    "NatronEngine.Natron.Python.BezierCurve.moveFeatherByIndex(index:int,time:double,dx:double,dy:double)",
    "NatronEngine.Natron.Python.BezierCurve.moveLeftBezierPoint(index:int,time:double,dx:double,dy:double)",
    "NatronEngine.Natron.Python.BezierCurve.movePointByIndex(index:int,time:double,dx:double,dy:double)",
    "NatronEngine.Natron.Python.BezierCurve.moveRightBezierPoint(index:int,time:double,dx:double,dy:double)",
    "NatronEngine.Natron.Python.BezierCurve.removeControlPointByIndex(index:int)",
    "NatronEngine.Natron.Python.BezierCurve.setActivated(time:double,activated:bool)",
    "NatronEngine.Natron.Python.BezierCurve.setColor(time:double,r:double,g:double,b:double)",
    "NatronEngine.Natron.Python.BezierCurve.setCompositingOperator(op:NatronEngine.Natron.MergingFunctionEnum)",
    "NatronEngine.Natron.Python.BezierCurve.setCurveFinished(finished:bool)",
    "NatronEngine.Natron.Python.BezierCurve.setFeatherDistance(dist:double,time:double)",
    "NatronEngine.Natron.Python.BezierCurve.setFeatherFallOff(falloff:double,time:double)",
    "NatronEngine.Natron.Python.BezierCurve.setFeatherPointAtIndex(index:int,time:double,x:double,y:double,lx:double,ly:double,rx:double,ry:double)",
    "NatronEngine.Natron.Python.BezierCurve.setOpacity(opacity:double,time:double)",
    "NatronEngine.Natron.Python.BezierCurve.setOverlayColor(r:double,g:double,b:double)",
    "NatronEngine.Natron.Python.BezierCurve.setPointAtIndex(index:int,time:double,x:double,y:double,lx:double,ly:double,rx:double,ry:double)",
    nullptr}; // Sentinel
