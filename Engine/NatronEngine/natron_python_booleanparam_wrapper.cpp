...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_addAsDependencyOf(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
    int overloadId = -1;
    ...
    // 0: BooleanParam::addAsDependencyOf(int,Natron::Python::Param*,int)
    if (numArgs == 3
...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_get(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    switch (overloadId) {
        case 0: // get() const
        {
            ...
            if (!PyErr_Occurred()) {
                // get()const
                bool cppResult = const_cast<const ::Natron::Python::BooleanParam *>(cppSelf)->get();
                pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
            }
            break;
        }
        case 1: // get(double frame) const
        {
            ...
            if (!PyErr_Occurred()) {
                // get(double)const
                bool cppResult = const_cast<const ::Natron::Python::BooleanParam *>(cppSelf)->get(cppArg0);
                pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
            }
            break;
        }
...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_getDefaultValue(PyObject *self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            bool cppResult = const_cast<const ::Natron::Python::BooleanParam *>(cppSelf)->getDefaultValue();
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
        }
    }
...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_getValue(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // getValue()const
            bool cppResult = const_cast<const ::Natron::Python::BooleanParam *>(cppSelf)->getValue();
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
        }
    }
...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_getValueAtTime(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            bool cppResult = const_cast<const ::Natron::Python::BooleanParam *>(cppSelf)->getValueAtTime(cppArg0);
            pyResult = Shiboken::Conversions::copyToPython(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), &cppResult);
        }
    }
    ...
    Sbk_Natron_Python_BooleanParamFunc_getValueAtTime_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "NatronEngine.Natron.Python.BooleanParam.getValueAtTime");
        return {};
}

static PyObject *Sbk_Natron_Python_BooleanParamFunc_restoreDefaultValue(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_set(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyObject *Sbk_Natron_Python_BooleanParamFunc_setValue(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    Sbk_Natron_Python_BooleanParamFunc_setValue_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "NatronEngine.Natron.Python.BooleanParam.setValue");
        return {};
}

static PyObject *Sbk_Natron_Python_BooleanParamFunc_setValueAtTime(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyMethodDef Sbk_Natron_Python_BooleanParam_methods[] = {
    ...
    {"get", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_get), METH_VARARGS},
    {"getDefaultValue", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_getDefaultValue), METH_NOARGS},
    {"getValue", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_getValue), METH_NOARGS},
    {"getValueAtTime", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_getValueAtTime), METH_O},
    {"restoreDefaultValue", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_restoreDefaultValue), METH_NOARGS},
    {"set", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_set), METH_VARARGS},
    {"setDefaultValue", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_setDefaultValue), METH_O},
    {"setValue", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_setValue), METH_O},
    {"setValueAtTime", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_BooleanParamFunc_setValueAtTime), METH_VARARGS},

    {nullptr, nullptr} // Sentinel
};

static int Sbk_Natron_Python_BooleanParam_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::BooleanParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLEANPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_BooleanParam_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_BooleanParam_setattro)},
...
static PyType_Spec Sbk_Natron_Python_BooleanParam_spec = {
    "1:NatronEngine.Natron.Python.BooleanParam",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_BooleanParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.BooleanParam.addAsDependencyOf(fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->bool",
    "1:NatronEngine.Natron.Python.BooleanParam.get()->bool",
    "0:NatronEngine.Natron.Python.BooleanParam.get(frame:double)->bool",
    "NatronEngine.Natron.Python.BooleanParam.getDefaultValue()->bool",
    "NatronEngine.Natron.Python.BooleanParam.getValue()->bool",
    "NatronEngine.Natron.Python.BooleanParam.getValueAtTime(time:double)->bool",
    "NatronEngine.Natron.Python.BooleanParam.restoreDefaultValue()",
    "1:NatronEngine.Natron.Python.BooleanParam.set(x:bool)",
    "0:NatronEngine.Natron.Python.BooleanParam.set(x:bool,frame:double)",
    "NatronEngine.Natron.Python.BooleanParam.setDefaultValue(value:bool)",
    "NatronEngine.Natron.Python.BooleanParam.setValue(value:bool)",
    "NatronEngine.Natron.Python.BooleanParam.setValueAtTime(value:bool,time:double)",
    nullptr}; // Sentinel
