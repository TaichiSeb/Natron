...
static PyObject *Sbk_Natron_RectIFunc_area(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::RectI *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_RECTI_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // area()const
            unsigned long long cppResult = const_cast<const ::Natron::RectI *>(cppSelf)->area();
    ...
    switch (overloadId) {
        case 0: // intersect(const Natron::RectI & r, Natron::RectI * intersection) const
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                pyResult = Shiboken::Conversions::copyToPython(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_RECTI_IDX]), &t);
                return pyResult;
...
static PyMethodDef Sbk_Natron_RectI_methods[] = {
    {"area", reinterpret_cast<PyCFunction>(Sbk_Natron_RectIFunc_area), METH_NOARGS},
...
static int Sbk_Natron_RectI_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::RectI *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_RECTI_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_RectI_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_RectI_setattro)},
...
static const char *Natron_RectI_SignatureStrings[] = {
    ...
    "NatronEngine.Natron.RectI.area()->unsigned long long",
