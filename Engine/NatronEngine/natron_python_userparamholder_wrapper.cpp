...
static PyObject *Sbk_Natron_Python_UserParamHolderFunc_createBooleanParam(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::UserParamHolder *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_USERPARAMHOLDER_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
    int overloadId = -1;
...
static PyObject *Sbk_Natron_Python_UserParamHolderFunc_createOutputFileParam(PyObject *self, PyObject *args)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            Natron::Python::OutputFileParam * cppResult = cppSelf->createOutputFileParam(cppArg0, cppArg1);
            pyResult = Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_PYTHON_OUTPUTFILEPARAM_IDX]), cppResult);
...
static int Sbk_Natron_Python_UserParamHolder_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::UserParamHolder *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_USERPARAMHOLDER_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_UserParamHolder_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_UserParamHolder_setattro)},
...
static PyType_Spec Sbk_Natron_Python_UserParamHolder_spec = {
    "1:NatronEngine.Natron.Python.UserParamHolder",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_UserParamHolder_SignatureStrings[] = {
    ...
    "NatronEngine.Natron.Python.UserParamHolder.createOutputFileParam(name:QString,label:QString)->NatronEngine.Natron.Python.OutputFileParam",
