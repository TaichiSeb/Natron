...
enum : int {
    ...
    SBK_NATRON_STATUSENUM_IDX                                = 62,
    SBK_NATRON_STANDARDBUTTONENUM_IDX                        = 61,
    SBK_QFLAGS_NATRON_STANDARDBUTTONENUM_IDX                 = 68,
    SBK_NATRON_KEYFRAMETYPEENUM_IDX                          = 8,
    SBK_NATRON_PIXMAPENUM_IDX                                = 11,
    SBK_NATRON_VALUECHANGEDREASONENUM_IDX                    = 63,
    SBK_NATRON_ANIMATIONLEVELENUM_IDX                        = 2,
    SBK_NATRON_IMAGEPREMULTIPLICATIONENUM_IDX                = 6,
    SBK_NATRON_VIEWERCOMPOSITINGOPERATORENUM_IDX             = 65,
    SBK_NATRON_VIEWERCOLORSPACEENUM_IDX                      = 64,
    SBK_NATRON_IMAGEBITDEPTHENUM_IDX                         = 5,
    SBK_NATRON_ORIENTATIONENUM_IDX                           = 10,
    SBK_NATRON_PLAYBACKMODEENUM_IDX                          = 12,
    SBK_NATRON_DISPLAYCHANNELSENUM_IDX                       = 4,
    SBK_NATRON_MERGINGFUNCTIONENUM_IDX                       = 9,
    SBK_NATRON_KEYBOARDMODIFIERENUM_IDX                      = 7,
    SBK_QFLAGS_NATRON_KEYBOARDMODIFIERENUM_IDX               = 67,
    SBK_NATRON_APPINSTANCESTATUSENUM_IDX                     = 3,
    SBK_NatronEngineNATRON_PYTHON_IDX                        = 13,
    SBK_NATRON_PYTHON_ANIMATEDPARAM_IDX                      = 14,
    SBK_NATRON_PYTHON_APP_IDX                                = 15,
    SBK_NATRON_PYTHON_APPSETTINGS_IDX                        = 16,
    SBK_NATRON_PYTHON_BEZIERCURVE_IDX                        = 17,
    SBK_NATRON_PYTHON_BOOLNODECREATIONPROPERTY_IDX           = 18,
    SBK_NATRON_PYTHON_BOOLEANPARAM_IDX                       = 19,
    SBK_NATRON_PYTHON_BUTTONPARAM_IDX                        = 20,
    SBK_NATRON_PYTHON_CHOICEPARAM_IDX                        = 21,
    SBK_NATRON_PYTHON_COLORPARAM_IDX                         = 22,
    SBK_NATRON_PYTHON_COLORTUPLE_IDX                         = 23,
    SBK_NATRON_PYTHON_DOUBLE2DPARAM_IDX                      = 24,
    SBK_NATRON_PYTHON_DOUBLE2DTUPLE_IDX                      = 25,
    SBK_NATRON_PYTHON_DOUBLE3DPARAM_IDX                      = 26,
    SBK_NATRON_PYTHON_DOUBLE3DTUPLE_IDX                      = 27,
    SBK_NATRON_PYTHON_DOUBLEPARAM_IDX                        = 28,
    SBK_NATRON_PYTHON_EFFECT_IDX                             = 29,
    SBK_NATRON_PYTHON_EXPRUTILS_IDX                          = 30,
    SBK_NATRON_PYTHON_FILEPARAM_IDX                          = 31,
    SBK_NATRON_PYTHON_FLOATNODECREATIONPROPERTY_IDX          = 32,
    SBK_NATRON_PYTHON_GROUP_IDX                              = 33,
    SBK_NATRON_PYTHON_GROUPPARAM_IDX                         = 34,
    SBK_NATRON_PYTHON_IMAGELAYER_IDX                         = 35,
    SBK_NATRON_PYTHON_INT2DPARAM_IDX                         = 36,
    SBK_NATRON_PYTHON_INT2DTUPLE_IDX                         = 37,
    SBK_NATRON_PYTHON_INT3DPARAM_IDX                         = 38,
    SBK_NATRON_PYTHON_INT3DTUPLE_IDX                         = 39,
    SBK_NATRON_PYTHON_INTNODECREATIONPROPERTY_IDX            = 40,
    SBK_NATRON_PYTHON_INTPARAM_IDX                           = 41,
    SBK_NATRON_PYTHON_ITEMBASE_IDX                           = 42,
    SBK_NATRON_PYTHON_LAYER_IDX                              = 43,
    SBK_NATRON_PYTHON_NODECREATIONPROPERTY_IDX               = 44,
    SBK_NATRON_PYTHON_OUTPUTFILEPARAM_IDX                    = 45,
    SBK_NATRON_PYTHON_PAGEPARAM_IDX                          = 46,
    SBK_NATRON_PYTHON_PARAM_IDX                              = 47,
    SBK_NATRON_PYTHON_PARAMETRICPARAM_IDX                    = 48,
    SBK_NATRON_PYTHON_PATHPARAM_IDX                          = 49,
    SBK_NATRON_PYTHON_ROTO_IDX                               = 50,
    SBK_NATRON_PYTHON_SEPARATORPARAM_IDX                     = 51,
    SBK_NATRON_PYTHON_STRINGNODECREATIONPROPERTY_IDX         = 52,
    SBK_NATRON_PYTHON_STRINGPARAM_IDX                        = 53,
    SBK_NATRON_PYTHON_STRINGPARAM_TYPEENUM_IDX               = 54,
    SBK_NATRON_PYTHON_STRINGPARAMBASE_IDX                    = 55,
    SBK_NATRON_PYTHON_TRACK_IDX                              = 56,
    SBK_NATRON_PYTHON_TRACKER_IDX                            = 57,
    SBK_NATRON_PYTHON_USERPARAMHOLDER_IDX                    = 58,
    SBK_NATRON_RECTD_IDX                                     = 59,
    SBK_NATRON_RECTI_IDX                                     = 60,
    SBK_PYCOREAPPLICATION_IDX                                = 66,
...
enum : int {
    ...
    SBK_NATRONENGINE_STD_LIST_NATRON_PYTHON_TRACKPTR_IDX     = 15, // std::list<Natron::Python::Track* > *
    SBK_NATRONENGINE_STD_VECTOR_STD_STRING_IDX               = 16, // const std::vector<std::string > &
...
template<> inline PyTypeObject *SbkType< ::QFlags<Natron::KeyboardModifierEnum> >() { return SbkNatronEngineTypes[SBK_QFLAGS_NATRON_KEYBOARDMODIFIERENUM_IDX]; }
