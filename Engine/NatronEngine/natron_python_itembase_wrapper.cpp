...
static const char *Natron_Python_ItemBase_SignatureStrings[] = {
    ...
    "NatronEngine.Natron.Python.ItemBase.getLocked()->bool",
    "NatronEngine.Natron.Python.ItemBase.getLockedRecursive()->bool",
    "NatronEngine.Natron.Python.ItemBase.getParam(name:QString)->NatronEngine.Natron.Python.Param",
    "NatronEngine.Natron.Python.ItemBase.getParentLayer()->NatronEngine.Natron.Python.Layer",
    "NatronEngine.Natron.Python.ItemBase.getScriptName()->QString",
    "NatronEngine.Natron.Python.ItemBase.getVisible()->bool",
    "NatronEngine.Natron.Python.ItemBase.setLabel(name:QString)",
    "NatronEngine.Natron.Python.ItemBase.setLocked(locked:bool)",
    "NatronEngine.Natron.Python.ItemBase.setScriptName(name:QString)->bool",
    "NatronEngine.Natron.Python.ItemBase.setVisible(activated:bool)",
    nullptr}; // Sentinel
