...
static const char *Natron_Python_Layer_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Layer.addItem(item:NatronEngine.Natron.Python.ItemBase)",
    "NatronEngine.Natron.Python.Layer.getChildren()->std.list[NatronEngine.Natron.Python.ItemBase]",
    "NatronEngine.Natron.Python.Layer.insertItem(pos:int,item:NatronEngine.Natron.Python.ItemBase)",
    "NatronEngine.Natron.Python.Layer.removeItem(item:NatronEngine.Natron.Python.ItemBase)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Layer(PyObject *enclosingClass)
{
    _Sbk_Natron_Python_Layer_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        Natron_Python_Layer_SignatureStrings,
