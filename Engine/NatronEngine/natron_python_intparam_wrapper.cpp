...
static const char *Natron_Python_IntParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.IntParam.addAsDependencyOf(fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->int",
    "1:NatronEngine.Natron.Python.IntParam.get()->int",
    "0:NatronEngine.Natron.Python.IntParam.get(frame:double)->int",
    ...
    "NatronEngine.Natron.Python.IntParam.getValue(dimension:int=0)->int",
    "NatronEngine.Natron.Python.IntParam.getValueAtTime(time:double,dimension:int=0)->int",
    "NatronEngine.Natron.Python.IntParam.restoreDefaultValue(dimension:int=0)",
    "1:NatronEngine.Natron.Python.IntParam.set(x:int)",
    "0:NatronEngine.Natron.Python.IntParam.set(x:int,frame:double)",
    ...
    "NatronEngine.Natron.Python.IntParam.setValue(value:int,dimension:int=0)",
    "NatronEngine.Natron.Python.IntParam.setValueAtTime(value:int,time:double,dimension:int=0)",
    nullptr}; // Sentinel
