...
extern "C" {
static PyObject *Sbk_Natron_Python_Int3DParamFunc_get(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Int3DParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT3DPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
    int overloadId = -1;
    ...
    switch (overloadId) {
        case 0: // get() const
        {
            ...
            if (!PyErr_Occurred()) {
                // get()const
                Natron::Python::Int3DTuple* cppResult = new Natron::Python::Int3DTuple(const_cast<const ::Natron::Python::Int3DParam *>(cppSelf)->get());
        ...
        case 1: // get(double frame) const
        {
            ...
            if (!PyErr_Occurred()) {
                // get(double)const
                Natron::Python::Int3DTuple* cppResult = new Natron::Python::Int3DTuple(const_cast<const ::Natron::Python::Int3DParam *>(cppSelf)->get(cppArg0));
                pyResult = Shiboken::Object::newObject(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT3DTUPLE_IDX]), cppResult, true, true);
            }
            break;
        }
...
static PyObject *Sbk_Natron_Python_Int3DParamFunc_set(PyObject *self, PyObject *args)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Int3DParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT3DPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    switch (overloadId) {
        ...
        case 1: // set(int x, int y)
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                ((Natron::Python::Int2DParam*)cppSelf)->set(cppArg0,cppArg1);
...
static PyMethodDef Sbk_Natron_Python_Int3DParam_methods[] = {
    {"get", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_Int3DParamFunc_get), METH_VARARGS},
    {"set", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_Int3DParamFunc_set), METH_VARARGS},

    {nullptr, nullptr} // Sentinel
};

static int Sbk_Natron_Python_Int3DParam_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::Int3DParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT3DPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_Int3DParam_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_Int3DParam_setattro)},
...
static PyType_Spec Sbk_Natron_Python_Int3DParam_spec = {
    "1:NatronEngine.Natron.Python.Int3DParam",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_Int3DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Int3DParam.get()->NatronEngine.Natron.Python.Int3DTuple",
    "0:NatronEngine.Natron.Python.Int3DParam.get(frame:double)->NatronEngine.Natron.Python.Int3DTuple",
    "3:NatronEngine.Natron.Python.Int3DParam.set(x:int,y:int,z:int)",
    "2:NatronEngine.Natron.Python.Int3DParam.set(x:int,y:int)",
    "1:NatronEngine.Natron.Python.Int3DParam.set(x:int)",
    "0:NatronEngine.Natron.Python.Int3DParam.set(x:int,y:int,z:int,frame:double)",
    nullptr}; // Sentinel
