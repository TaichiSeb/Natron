...
{
public:
    inline void _addAsDependencyOf_protected(int fromExprDimension, Natron::Python::Param * param, int thisDimension) { Natron::Python::SeparatorParam::_addAsDependencyOf(fromExprDimension, param, thisDimension); }
