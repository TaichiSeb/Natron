...
PyObject* Sbk_Natron_Python_Double3DTupleFunc___getitem__(PyObject *self, Py_ssize_t _i)
{
    ...
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Double3DTuple *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_DOUBLE3DTUPLE_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
...
static PyType_Spec Sbk_Natron_Python_Double3DTuple_spec = {
    "1:NatronEngine.Natron.Python.Double3DTuple",
    sizeof(SbkObject),
    0,
