...
static const char *Natron_Python_Param_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Param._addAsDependencyOf(fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)",
    "NatronEngine.Natron.Python.Param.copy(other:NatronEngine.Natron.Python.Param,dimension:int=-1)->bool",
    "NatronEngine.Natron.Python.Param.curve(time:double,dimension:int=0)->double",
    ...
    "NatronEngine.Natron.Python.Param.getIsEnabled(dimension:int=0)->bool",
    ...
    "NatronEngine.Natron.Python.Param.setEnabled(enabled:bool,dimension:int=0)",
    "NatronEngine.Natron.Python.Param.setEnabledByDefault(enabled:bool=0)",
    "NatronEngine.Natron.Python.Param.setEvaluateOnChange(eval:bool)",
    "NatronEngine.Natron.Python.Param.setHelp(help:QString)",
    "NatronEngine.Natron.Python.Param.setIconFilePath(icon:QString)",
    "NatronEngine.Natron.Python.Param.setPersistent(persistent:bool)",
    "NatronEngine.Natron.Python.Param.setVisible(visible:bool)",
    "NatronEngine.Natron.Python.Param.setVisibleByDefault(visible:bool)",
    "NatronEngine.Natron.Python.Param.slaveTo(other:NatronEngine.Natron.Python.Param,thisDimension:int,otherDimension:int)->bool",
    "NatronEngine.Natron.Python.Param.unslave(dimension:int)",
    nullptr}; // Sentinel
