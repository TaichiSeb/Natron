...
static int Sbk_Natron_Python_NodeCreationProperty_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::NodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_NODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_NodeCreationProperty_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_NodeCreationProperty_setattro)},
...
static PyType_Spec Sbk_Natron_Python_NodeCreationProperty_spec = {
    "1:NatronEngine.Natron.Python.NodeCreationProperty",
    sizeof(SbkObject),
    0,
