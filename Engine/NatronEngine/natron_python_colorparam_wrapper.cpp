...
static const char *Natron_Python_ColorParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.ColorParam.addAsDependencyOf(fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->double",
    "1:NatronEngine.Natron.Python.ColorParam.get()->NatronEngine.Natron.Python.ColorTuple",
    "0:NatronEngine.Natron.Python.ColorParam.get(frame:double)->NatronEngine.Natron.Python.ColorTuple",
    ...
    "NatronEngine.Natron.Python.ColorParam.getValue(dimension:int=0)->double",
    "NatronEngine.Natron.Python.ColorParam.getValueAtTime(time:double,dimension:int=0)->double",
    "NatronEngine.Natron.Python.ColorParam.restoreDefaultValue(dimension:int=0)",
    "1:NatronEngine.Natron.Python.ColorParam.set(r:double,g:double,b:double,a:double)",
    "0:NatronEngine.Natron.Python.ColorParam.set(r:double,g:double,b:double,a:double,frame:double)",
    ...
    "NatronEngine.Natron.Python.ColorParam.setValue(value:double,dimension:int=0)",
    "NatronEngine.Natron.Python.ColorParam.setValueAtTime(value:double,time:double,dimension:int=0)",
    nullptr}; // Sentinel
