...
static PyObject *Sbk_Natron_RectDFunc_area(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::RectD *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_RECTD_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
    ...
    switch (overloadId) {
        case 0: // intersect(const Natron::RectD & r, Natron::RectD * intersection) const
        {
            ...
            if (!PyErr_Occurred()) {
                ...
                pyResult = Shiboken::Conversions::copyToPython(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_RECTD_IDX]), &t);
                return pyResult;
...
static int Sbk_Natron_RectD_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::RectD *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_RECTD_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_RectD_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_RectD_setattro)},
