...
static const char *Natron_Python_AnimatedParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.AnimatedParam.deleteValueAtTime(time:double,dimension:int=0)",
    "NatronEngine.Natron.Python.AnimatedParam.getCurrentTime()->int",
    "NatronEngine.Natron.Python.AnimatedParam.getDerivativeAtTime(time:double,dimension:int=0)->double",
    "NatronEngine.Natron.Python.AnimatedParam.getExpression(dimension:int,hasRetVariable:bool*)->QString",
    "NatronEngine.Natron.Python.AnimatedParam.getIntegrateFromTimeToTime(time1:double,time2:double,dimension:int=0)->double",
    "NatronEngine.Natron.Python.AnimatedParam.getIsAnimated(dimension:int=0)->bool",
    "NatronEngine.Natron.Python.AnimatedParam.getKeyIndex(time:double,dimension:int=0)->int",
    "NatronEngine.Natron.Python.AnimatedParam.getKeyTime(index:int,dimension:int,time:double*)->bool",
    "NatronEngine.Natron.Python.AnimatedParam.getNumKeys(dimension:int=0)->int",
    "NatronEngine.Natron.Python.AnimatedParam.removeAnimation(dimension:int=0)",
    "NatronEngine.Natron.Python.AnimatedParam.setExpression(expr:QString,hasRetVariable:bool,dimension:int=0)->bool",
    "NatronEngine.Natron.Python.AnimatedParam.setInterpolationAtTime(time:double,interpolation:NatronEngine.Natron.KeyframeTypeEnum,dimension:int=0)->bool",
    nullptr}; // Sentinel
