...
static const char *Natron_Python_Track_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Track.getParam(scriptName:QString)->NatronEngine.Natron.Python.Param",
    "NatronEngine.Natron.Python.Track.getParams()->std.list[NatronEngine.Natron.Python.Param]",
    "NatronEngine.Natron.Python.Track.getScriptName()->QString",
    "NatronEngine.Natron.Python.Track.reset()",
    "NatronEngine.Natron.Python.Track.setScriptName(scriptName:QString)",
    nullptr}; // Sentinel
