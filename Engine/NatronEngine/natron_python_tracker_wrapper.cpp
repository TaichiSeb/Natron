...
static PyObject *Sbk_Natron_Python_TrackerFunc_createTrack(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Tracker *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACKER_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
...
static PyObject *Sbk_Natron_Python_TrackerFunc_getAllTracks(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Tracker *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACKER_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // getAllTracks(std::list<Natron::Python::Track*>*)const
            // Begin code injection

            std::list<Natron::Python::Track*> tracks;
            cppSelf->getAllTracks(&tracks);
            PyObject* ret = PyList_New((int) tracks.size());
            int idx = 0;
            for (std::list<Natron::Python::Track*>::iterator it = tracks.begin(); it!=tracks.end(); ++it,++idx) {
            PyObject* item = Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACK_IDX]), *it);
            // Ownership transferences.
...
static PyObject *Sbk_Natron_Python_TrackerFunc_getSelectedTracks(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Tracker *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACKER_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // getSelectedTracks(std::list<Natron::Python::Track*>*)const
            // Begin code injection
...
static PyObject *Sbk_Natron_Python_TrackerFunc_getTrackByName(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Tracker *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACKER_IDX], reinterpret_cast<SbkObject *>(self)));
    ...
    if (overloadId == -1) goto Sbk_Natron_Python_TrackerFunc_getTrackByName_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            Natron::Python::Track * cppResult = const_cast<const ::Natron::Python::Tracker *>(cppSelf)->getTrackByName(cppArg0);
            pyResult = Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkNatronEngineTypes[SBK_NATRON_PYTHON_TRACK_IDX]), cppResult);
    ...
    Sbk_Natron_Python_TrackerFunc_getTrackByName_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "NatronEngine.Natron.Python.Tracker.getTrackByName");
        return {};
}
...
static PyMethodDef Sbk_Natron_Python_Tracker_methods[] = {
    ...
    {"getAllTracks", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_TrackerFunc_getAllTracks), METH_NOARGS},
    {"getSelectedTracks", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_TrackerFunc_getSelectedTracks), METH_NOARGS},
    {"getTrackByName", reinterpret_cast<PyCFunction>(Sbk_Natron_Python_TrackerFunc_getTrackByName), METH_O},
...
static PyType_Spec Sbk_Natron_Python_Tracker_spec = {
    "1:NatronEngine.Natron.Python.Tracker",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_Tracker_SignatureStrings[] = {
    ...
    "NatronEngine.Natron.Python.Tracker.getAllTracks(markers:std.list[NatronEngine.Natron.Python.Track])",
    "NatronEngine.Natron.Python.Tracker.getSelectedTracks(markers:std.list[NatronEngine.Natron.Python.Track])",
    "NatronEngine.Natron.Python.Tracker.getTrackByName(name:QString)->NatronEngine.Natron.Python.Track",
    "NatronEngine.Natron.Python.Tracker.startTracking(marks:std.list[NatronEngine.Natron.Python.Track],start:int,end:int,forward:bool)",
