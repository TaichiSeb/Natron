...
static PyObject *Sbk_Natron_Python_PathParamFunc_getTable(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::PathParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_PATHPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
...
static int Sbk_Natron_Python_PathParam_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::PathParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_PATHPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_PathParam_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_PathParam_setattro)},
...
static PyType_Spec Sbk_Natron_Python_PathParam_spec = {
    "1:NatronEngine.Natron.Python.PathParam",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_PathParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.PathParam.getTable(table:std.list[std.vector[std.string]])",
    "NatronEngine.Natron.Python.PathParam.setAsMultiPathTable()",
    "NatronEngine.Natron.Python.PathParam.setTable(table:std.list[std.vector[std.string]])",
    nullptr}; // Sentinel
