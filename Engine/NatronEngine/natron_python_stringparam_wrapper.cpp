...
void StringParamWrapper::pysideInitQtMetaTypes()
{
    ...
    qRegisterMetaType< ::Natron::Python::StringParam::TypeEnum >("Python::StringParam::TypeEnum");
    qRegisterMetaType< ::Natron::Python::StringParam::TypeEnum >("Natron::Python::StringParam::TypeEnum");
}
...
static PyObject *Sbk_Natron_Python_StringParamFunc_setType(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::StringParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_STRINGPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    int overloadId = -1;
...
static int Sbk_Natron_Python_StringParam_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::StringParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_STRINGPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_StringParam_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_StringParam_setattro)},
...
static PyType_Spec Sbk_Natron_Python_StringParam_spec = {
    "1:NatronEngine.Natron.Python.StringParam",
    sizeof(SbkObject),
    0,
...
void init_Natron_Python_StringParam(PyObject *enclosingClass)
{
    ...
    SbkNatronEngineTypes[SBK_NATRON_PYTHON_STRINGPARAM_TYPEENUM_IDX] = Shiboken::Enum::createScopedEnum(Sbk_Natron_Python_StringParam_TypeF(),
        "TypeEnum",
        "1:NatronEngine.Natron.Python.StringParam.TypeEnum",
