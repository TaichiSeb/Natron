...
static PyObject *Sbk_Natron_Python_AppFunc_addFormat(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = static_cast<AppWrapper *>(reinterpret_cast< ::Natron::Python::App *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_APP_IDX], reinterpret_cast<SbkObject *>(self))));
    SBK_UNUSED(cppSelf)
    int overloadId = -1;
...
static int Sbk_Natron_Python_App_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::App *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_APP_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_App_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_App_setattro)},
...
static PyType_Spec Sbk_Natron_Python_App_spec = {
    "1:NatronEngine.Natron.Python.App",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_App_SignatureStrings[] = {
    ...
    "NatronEngine.Natron.Python.App.createNode(pluginID:QString,majorVersion:int=-1,group:NatronEngine.Natron.Python.Group=0,props:std.map[QString, NatronEngine.Natron.Python.NodeCreationProperty]=NodeCreationPropertyMap())->NatronEngine.Natron.Python.Effect",
    "NatronEngine.Natron.Python.App.createReader(filename:QString,group:NatronEngine.Natron.Python.Group=0,props:std.map[QString, NatronEngine.Natron.Python.NodeCreationProperty]=NodeCreationPropertyMap())->NatronEngine.Natron.Python.Effect",
    "NatronEngine.Natron.Python.App.createWriter(filename:QString,group:NatronEngine.Natron.Python.Group=0,props:std.map[QString, NatronEngine.Natron.Python.NodeCreationProperty]=NodeCreationPropertyMap())->NatronEngine.Natron.Python.Effect",
    ...
    "NatronEngine.Natron.Python.App.getViewNames()->std.list[QString]",
    ...
    "0:NatronEngine.Natron.Python.App.render(effects:std.list[NatronEngine.Natron.Python.Effect],firstFrames:std.list[int],lastFrames:std.list[int],frameSteps:std.list[int])",
