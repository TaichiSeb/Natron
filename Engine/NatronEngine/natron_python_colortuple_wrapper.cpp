...
PyObject* Sbk_Natron_Python_ColorTupleFunc___getitem__(PyObject *self, Py_ssize_t _i)
{
    ...
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::ColorTuple *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_COLORTUPLE_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
...
static PyType_Spec Sbk_Natron_Python_ColorTuple_spec = {
    "1:NatronEngine.Natron.Python.ColorTuple",
    sizeof(SbkObject),
    0,
