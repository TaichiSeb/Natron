...
static const char *Natron_Python_ParametricParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.ParametricParam.addControlPoint(dimension:int,key:double,value:double,interpolation:NatronEngine.Natron.KeyframeTypeEnum=eKeyframeTypeSmooth)->NatronEngine.Natron.StatusEnum",
    "0:NatronEngine.Natron.Python.ParametricParam.addControlPoint(dimension:int,key:double,value:double,leftDerivative:double,rightDerivative:double,interpolation:NatronEngine.Natron.KeyframeTypeEnum=eKeyframeTypeSmooth)->NatronEngine.Natron.StatusEnum",
    "NatronEngine.Natron.Python.ParametricParam.deleteAllControlPoints(dimension:int)->NatronEngine.Natron.StatusEnum",
    "NatronEngine.Natron.Python.ParametricParam.deleteControlPoint(dimension:int,nthCtl:int)->NatronEngine.Natron.StatusEnum",
    ...
    "NatronEngine.Natron.Python.ParametricParam.getNthControlPoint(dimension:int,nthCtl:int,key:double*,value:double*,leftDerivative:double*,rightDerivative:double*)->NatronEngine.Natron.StatusEnum",
    ...
    "NatronEngine.Natron.Python.ParametricParam.setNthControlPoint(dimension:int,nthCtl:int,key:double,value:double,leftDerivative:double,rightDerivative:double)->NatronEngine.Natron.StatusEnum",
    "NatronEngine.Natron.Python.ParametricParam.setNthControlPointInterpolation(dimension:int,nThCtl:int,interpolation:NatronEngine.Natron.KeyframeTypeEnum)->NatronEngine.Natron.StatusEnum",
    nullptr}; // Sentinel
