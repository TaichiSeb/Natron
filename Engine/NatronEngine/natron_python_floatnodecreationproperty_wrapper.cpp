...
static PyObject *Sbk_Natron_Python_FloatNodeCreationPropertyFunc_getValues(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::FloatNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_FLOATNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
...
static int Sbk_Natron_Python_FloatNodeCreationProperty_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::FloatNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_FLOATNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_FloatNodeCreationProperty_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_FloatNodeCreationProperty_setattro)},
...
static PyType_Spec Sbk_Natron_Python_FloatNodeCreationProperty_spec = {
    "1:NatronEngine.Natron.Python.FloatNodeCreationProperty",
    sizeof(SbkObject),
    0,
...
static void *Sbk_Natron_Python_FloatNodeCreationProperty_typeDiscovery(void *cptr, SbkObjectType *instanceType)
{
    if (instanceType == reinterpret_cast<SbkObjectType *>(Shiboken::SbkType< ::Natron::Python::NodeCreationProperty >()))
        return dynamic_cast< ::Natron::Python::FloatNodeCreationProperty *>(reinterpret_cast< ::Natron::Python::NodeCreationProperty *>(cptr));
    return {};
}
...
static const char *Natron_Python_FloatNodeCreationProperty_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.FloatNodeCreationProperty(values:std.vector[double]=std.vector< double >())",
    "0:NatronEngine.Natron.Python.FloatNodeCreationProperty(value:double)",
    "NatronEngine.Natron.Python.FloatNodeCreationProperty.getValues()->std.vector[double]",
...
void init_Natron_Python_FloatNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(Sbk_Natron_Python_FloatNodeCreationProperty_TypeF(), &Sbk_Natron_Python_FloatNodeCreationProperty_typeDiscovery);
