...
static PyObject *Sbk_Natron_Python_StringNodeCreationPropertyFunc_getValues(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::StringNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_STRINGNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
...
static int Sbk_Natron_Python_StringNodeCreationProperty_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::StringNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_STRINGNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_StringNodeCreationProperty_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_StringNodeCreationProperty_setattro)},
...
static PyType_Spec Sbk_Natron_Python_StringNodeCreationProperty_spec = {
    "1:NatronEngine.Natron.Python.StringNodeCreationProperty",
    sizeof(SbkObject),
    0,
...
static void *Sbk_Natron_Python_StringNodeCreationProperty_typeDiscovery(void *cptr, SbkObjectType *instanceType)
{
    if (instanceType == reinterpret_cast<SbkObjectType *>(Shiboken::SbkType< ::Natron::Python::NodeCreationProperty >()))
        return dynamic_cast< ::Natron::Python::StringNodeCreationProperty *>(reinterpret_cast< ::Natron::Python::NodeCreationProperty *>(cptr));
    return {};
}
...
static const char *Natron_Python_StringNodeCreationProperty_SignatureStrings[] = {
    ...
    "0:NatronEngine.Natron.Python.StringNodeCreationProperty(values:std.vector[std.string]=std.vector< std.string >())",
    "NatronEngine.Natron.Python.StringNodeCreationProperty.getValues()->std.vector[std.string]",
...
void init_Natron_Python_StringNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(Sbk_Natron_Python_StringNodeCreationProperty_TypeF(), &Sbk_Natron_Python_StringNodeCreationProperty_typeDiscovery);
