...
static PyObject *Sbk_Natron_Python_BoolNodeCreationPropertyFunc_getValues(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::BoolNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
...
static int Sbk_Natron_Python_BoolNodeCreationProperty_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::BoolNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_BOOLNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_BoolNodeCreationProperty_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_BoolNodeCreationProperty_setattro)},
...
static PyType_Spec Sbk_Natron_Python_BoolNodeCreationProperty_spec = {
    "1:NatronEngine.Natron.Python.BoolNodeCreationProperty",
    sizeof(SbkObject),
    0,
...
static void *Sbk_Natron_Python_BoolNodeCreationProperty_typeDiscovery(void *cptr, SbkObjectType *instanceType)
{
    if (instanceType == reinterpret_cast<SbkObjectType *>(Shiboken::SbkType< ::Natron::Python::NodeCreationProperty >()))
        return dynamic_cast< ::Natron::Python::BoolNodeCreationProperty *>(reinterpret_cast< ::Natron::Python::NodeCreationProperty *>(cptr));
    return {};
}
...
static const char *Natron_Python_BoolNodeCreationProperty_SignatureStrings[] = {
    ...
    "0:NatronEngine.Natron.Python.BoolNodeCreationProperty(values:std.vector[bool]=std.vector< bool >())",
    "NatronEngine.Natron.Python.BoolNodeCreationProperty.getValues()->std.vector[bool]",
...
void init_Natron_Python_BoolNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(Sbk_Natron_Python_BoolNodeCreationProperty_TypeF(), &Sbk_Natron_Python_BoolNodeCreationProperty_typeDiscovery);
