...
static PyObject *Sbk_Natron_Python_PageParamFunc_addParam(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = static_cast<PageParamWrapper *>(reinterpret_cast< ::Natron::Python::PageParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_PAGEPARAM_IDX], reinterpret_cast<SbkObject *>(self))));
    SBK_UNUSED(cppSelf)
    int overloadId = -1;
...
static int Sbk_Natron_Python_PageParam_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::PageParam *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_PAGEPARAM_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_PageParam_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_PageParam_setattro)},
...
static PyType_Spec Sbk_Natron_Python_PageParam_spec = {
    "1:NatronEngine.Natron.Python.PageParam",
    sizeof(SbkObject),
    0,
