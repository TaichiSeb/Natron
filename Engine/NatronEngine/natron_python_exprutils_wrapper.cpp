...
static PyObject *Sbk_Natron_Python_ExprUtilsFunc_snoise(PyObject *self, PyObject *pyArg)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::ExprUtils *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_EXPRUTILS_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
...
static PyType_Spec Sbk_Natron_Python_ExprUtils_spec = {
    "1:NatronEngine.Natron.Python.ExprUtils",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_ExprUtils_SignatureStrings[] = {
    ...
    "NatronEngine.Natron.Python.ExprUtils.hash(args:std.vector[double])->double",
