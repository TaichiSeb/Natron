...
{
public:
    inline void _addAsDependencyOf_protected(int fromExprDimension, Natron::Python::Param * param, int thisDimension) { Natron::Python::ButtonParam::_addAsDependencyOf(fromExprDimension, param, thisDimension); }
    ~ButtonParamWrapper();
