...
PyObject* Sbk_Natron_Python_Int2DTupleFunc___getitem__(PyObject *self, Py_ssize_t _i)
{
    ...
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::Int2DTuple *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INT2DTUPLE_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
...
static PyType_Spec Sbk_Natron_Python_Int2DTuple_spec = {
    "1:NatronEngine.Natron.Python.Int2DTuple",
    sizeof(SbkObject),
    0,
