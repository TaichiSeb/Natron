...
static PyObject *Sbk_Natron_Python_IntNodeCreationPropertyFunc_getValues(PyObject *self)
{
    if (!Shiboken::Object::isValid(self))
        return {};
    auto cppSelf = reinterpret_cast< ::Natron::Python::IntNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INTNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
    SBK_UNUSED(cppSelf)
    PyObject *pyResult{};
...
static int Sbk_Natron_Python_IntNodeCreationProperty_setattro(PyObject *self, PyObject *name, PyObject *value)
{
    if (value && PyCallable_Check(value)) {
        auto plain_inst = reinterpret_cast< ::Natron::Python::IntNodeCreationProperty *>(Shiboken::Conversions::cppPointer(SbkNatronEngineTypes[SBK_NATRON_PYTHON_INTNODECREATIONPROPERTY_IDX], reinterpret_cast<SbkObject *>(self)));
...
static PyType_Slot Sbk_Natron_Python_IntNodeCreationProperty_slots[] = {
    ...
    {Py_tp_setattro,    reinterpret_cast<void *>(Sbk_Natron_Python_IntNodeCreationProperty_setattro)},
...
static PyType_Spec Sbk_Natron_Python_IntNodeCreationProperty_spec = {
    "1:NatronEngine.Natron.Python.IntNodeCreationProperty",
    sizeof(SbkObject),
    0,
...
static void *Sbk_Natron_Python_IntNodeCreationProperty_typeDiscovery(void *cptr, SbkObjectType *instanceType)
{
    if (instanceType == reinterpret_cast<SbkObjectType *>(Shiboken::SbkType< ::Natron::Python::NodeCreationProperty >()))
        return dynamic_cast< ::Natron::Python::IntNodeCreationProperty *>(reinterpret_cast< ::Natron::Python::NodeCreationProperty *>(cptr));
    return {};
}
...
static const char *Natron_Python_IntNodeCreationProperty_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.IntNodeCreationProperty(values:std.vector[int]=std.vector< int >())",
    "0:NatronEngine.Natron.Python.IntNodeCreationProperty(value:int)",
    "NatronEngine.Natron.Python.IntNodeCreationProperty.getValues()->std.vector[int]",
...
void init_Natron_Python_IntNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    Shiboken::ObjectType::setTypeDiscoveryFunctionV2(Sbk_Natron_Python_IntNodeCreationProperty_TypeF(), &Sbk_Natron_Python_IntNodeCreationProperty_typeDiscovery);
