...
public:
    ...
    RotoDrawableItemPrivate(bool isPaintingNode)
        ...
        , cacheAccessMutex()
    {
        opacity = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoOpacityParamLabel), 1, true);
        ...
        feather = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoFeatherParamLabel), 1, true);
        ...
        featherFallOff = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoFeatherFallOffParamLabel), 1, true);
        ...
        lifeTime = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoDrawableItemLifeTimeParamLabel), 1, true);
        ...
        lifeTimeFrame = std::make_shared<KnobInt>((KnobHolder*)nullptr, tr(kRotoDrawableItemLifeTimeFrameParamLabel), 1, true);
        ...
        activated = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoActivatedParamLabel), 1, true);
...
#ifdef NATRON_ROTO_INVERTIBLE
        inverted = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoInvertedParamLabel), 1, true) );
        ...
        color = std::make_shared<KnobColor>((KnobHolder*)nullptr, tr(kRotoColorParamLabel), 3, true);
        ...
        compOperator = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoCompOperatorParamLabel), 1, true);
        ...
        translate = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemTranslateParamLabel), 2, true);
        ...
        rotate = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemRotateParamLabel), 1, true);
        ...
        scale = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemScaleParamLabel), 2, true);
        ...
        scaleUniform = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoDrawableItemScaleUniformParamLabel), 1, true);
        ...
        skewX = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemSkewXParamLabel), 1, true);
        skewX->setName(kRotoDrawableItemSkewXParam);
        skewX->setHintToolTip( tr(kRotoDrawableItemSkewXParamHint) );
        skewX->populate();
        knobs.push_back(skewX);

        skewY = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemSkewYParamLabel), 1, true);
        skewY->setName(kRotoDrawableItemSkewYParam);
        skewY->setHintToolTip( tr(kRotoDrawableItemSkewYParamHint) );
        skewY->populate();
        knobs.push_back(skewY);

        skewOrder = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoDrawableItemSkewOrderParamLabel), 1, true);
        ...
        center = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemCenterParamLabel), 2, true);
        ...
        extraMatrix = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoDrawableItemExtraMatrixParamLabel), 9, true);
        ...
        brushSize = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushSizeParamLabel), 1, true);
        ...
        brushSpacing = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushSpacingParamLabel), 1, true);
        ...
        brushHardness = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushHardnessParamLabel), 1, true);
        ...
        effectStrength = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushEffectParamLabel), 1, true);
        ...
        pressureOpacity = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoBrushPressureOpacityParamLabel), 1, true);
        ...
        pressureSize = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoBrushPressureSizeParamLabel), 1, true);
        ...
        pressureHardness = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoBrushPressureHardnessParamLabel), 1, true);
        ...
        buildUp = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoBrushBuildupParamLabel), 1, true);
        ...
        visiblePortion = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushVisiblePortionParamLabel), 2, true);
        ...
        cloneTranslate = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushTranslateParamLabel), 2, true);
        ...
        cloneRotate = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushRotateParamLabel), 1, true);
        ...
        cloneScale = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushScaleParamLabel), 2, true);
        ...
        cloneScaleUniform = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoBrushScaleUniformParamLabel), 1, true);
        ...
        cloneSkewX = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushSkewXParamLabel), 1, true);
        cloneSkewX->setName(kRotoBrushSkewXParam);
        cloneSkewX->setHintToolTip( tr(kRotoBrushSkewXParamHint) );
        cloneSkewX->populate();
        knobs.push_back(cloneSkewX);

        cloneSkewY = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushSkewYParamLabel), 1, true);
        cloneSkewY->setName(kRotoBrushSkewYParam);
        cloneSkewY->setHintToolTip( tr(kRotoBrushSkewYParamHint) );
        cloneSkewY->populate();
        knobs.push_back(cloneSkewY);

        cloneSkewOrder = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoBrushSkewOrderParamLabel), 1, true);
        ...
        cloneCenter = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoBrushCenterParamLabel), 2, true);
        ...
        cloneFilter = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoBrushFilterParamLabel), 1, true);
...
#pragma message WARN("TODO: better sync with OFX filter param")
        ...
        cloneBlackOutside = std::make_shared<KnobBool>((KnobHolder*)nullptr, tr(kRotoBrushBlackOutsideParamLabel), 1, true);
        ...
        sourceColor = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoBrushSourceColorLabel), 1, true);
        ...
        timeOffset = std::make_shared<KnobInt>((KnobHolder*)nullptr, tr(kRotoBrushTimeOffsetParamLabel), 1, true);
        ...
        timeOffsetMode = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoBrushTimeOffsetModeParamLabel), 1, true);
...
#ifdef NATRON_ROTO_ENABLE_MOTION_BLUR
        motionBlur = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoMotionBlurParamLabel), 1, true);
        ...
        shutter = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoShutterParamLabel), 1, true);
        ...
        shutterType = std::make_shared<KnobChoice>((KnobHolder*)nullptr, tr(kRotoShutterOffsetTypeParamLabel), 1, true);
        ...
        customOffset = std::make_shared<KnobDouble>((KnobHolder*)nullptr, tr(kRotoShutterCustomOffsetParamLabel), 1, true);
