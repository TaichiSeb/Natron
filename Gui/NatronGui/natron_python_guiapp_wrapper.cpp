...
static PyObject *Sbk_Natron_Python_GuiAppFunc_getViewer(PyObject *self, PyObject *pyArg)
{
    ...
    Sbk_Natron_Python_GuiAppFunc_getViewer_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "NatronGui.Natron.Python.GuiApp.getViewer");
        return {};
}
...
static PyType_Spec Sbk_Natron_Python_GuiApp_spec = {
    "1:NatronGui.Natron.Python.GuiApp",
    sizeof(SbkObject),
    0,
...
static const char *Natron_Python_GuiApp_SignatureStrings[] = {
    ...
    "NatronGui.Natron.Python.GuiApp.getActiveViewer()->NatronGui.Natron.Python.PyViewer",
    ...
    "NatronGui.Natron.Python.GuiApp.getSelectedNodes(group:NatronEngine.Natron.Python.Group=0)->std.list[NatronEngine.Natron.Python.Effect]",
    ...
    "NatronGui.Natron.Python.GuiApp.getViewer(scriptName:QString)->NatronGui.Natron.Python.PyViewer",
    ...
    "0:NatronGui.Natron.Python.GuiApp.renderBlocking(effects:std.list[NatronEngine.Natron.Python.Effect],firstFrames:std.list[int],lastFrames:std.list[int],frameSteps:std.list[int])",
    ...
    "NatronGui.Natron.Python.GuiApp.setSelection(nodes:std.list[NatronEngine.Natron.Python.Effect])",
