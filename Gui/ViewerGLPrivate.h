...
struct ViewerGL::Implementation
{
    ...
    std::unique_ptr<QGLShaderProgram> shaderRGB; /*!< The shader program used to render RGB data*/
    std::unique_ptr<QGLShaderProgram> shaderBlack; /*!< The shader program used when the viewer is disconnected.*/
